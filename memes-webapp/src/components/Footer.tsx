...
export default function Footer(){
    return(
        <FooterTag>
            <Div><FooterP>© {new Date().getFullYear()} David Paulos | All rights reserved</FooterP>
            <LogosDiv>
            <a href="https://www.linkedin.com/in/david-paulos-web-developer" target="_blank" rel="noreferrer">
